...
return {
	...
	cbf_formspec = function(tabview, name, tabdata)
		...
		table.insert_all(hypertext, {
			"<heading>", fgettext_ne("Stonecraft Developers"), "</heading>\n",
		})
		prepare_credits(hypertext, credits.stonecraft_developers)
		table.insert_all(hypertext, {
		...
		table.insert_all(hypertext, {
			"\n",
			"<heading>", fgettext_ne("Luanti Core Team"), "</heading>\n",
		})
		prepare_credits(hypertext, credits.core_team)
		table.insert_all(hypertext, {
			"\n",
			"<heading>", fgettext_ne("Active Luanti Contributors"), "</heading>\n",
		})
		prepare_credits(hypertext, credits.contributors)
		table.insert_all(hypertext, {
			"\n",
			"<heading>", fgettext_ne("Previous Luanti Core Developers"), "</heading>\n",
		})
		prepare_credits(hypertext, credits.previous_core_developers)
		table.insert_all(hypertext, {
			"\n",
			"<heading>", fgettext_ne("Previous Luanti Contributors"), "</heading>\n",
		})
		...
		local fs = "image[1.5,0.6;2.5,2.5;" .. core.formspec_escape(logofile) .. "]" ..
			...
			"button_url[1.5,4.1;2.5,0.8;homepage;Homepage;http://mrcerealguy.github.io/stonecraft]" ..
