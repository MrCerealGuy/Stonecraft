...
static int lcf2 (lua_State * L) {
  ...
  lua_pushvalue(L,2);
  lua_pushvalue(L,3);
  lua_pushliteral(L,"ethereal:wild_onion_1");
...
static int lcf17 (lua_State * L) {
  ...
  if (!(lua_toboolean(L,-1))) {
    lua_pop(L,1);
    lua_pushnumber(L,13);
    const int lc15 = lua_lessthan(L,3,-1);
    lua_pop(L,1);
...
static int lcf_main (lua_State * L) {
  ...
  lua_pushliteral(L,"Wild Onion");
  lua_call(L,1,1);
  lua_rawset(L,-3);
  lua_pushliteral(L,"inventory_image");
  lua_pushliteral(L,"wild_onion.png");
  lua_rawset(L,-3);
  ...
  lua_pushliteral(L,"ethereal_wild_onion_1.png");
  lua_rawseti(L,-2,1);
  lua_rawset(L,-3);
  ...
  lua_pushliteral(L,"ethereal:onion_1");
  ...
  lua_createtable(L,1,0);
  lua_pushliteral(L,"ethereal_wild_onion_2.png");
  lua_rawseti(L,-2,1);
  lua_pushliteral(L,"tiles");
  lua_insert(L,-2);
  ...
  lua_pushliteral(L,"ethereal:onion_2");
  lua_getfield(L,LUA_ENVIRONINDEX,"table");
  lua_pushliteral(L,"copy");
  lua_gettable(L,-2);
  lua_remove(L,-2);
  ...
  lua_createtable(L,1,0);
  lua_pushliteral(L,"ethereal_wild_onion_3.png");
  lua_rawseti(L,-2,1);
  lua_pushliteral(L,"tiles");
  lua_insert(L,-2);
  lua_settable(L,(2 + lc_nextra));
  ...
  lua_pushliteral(L,"ethereal:onion_3");
  lua_getfield(L,LUA_ENVIRONINDEX,"table");
  lua_pushliteral(L,"copy");
  lua_gettable(L,-2);
  lua_remove(L,-2);
  ...
  lua_createtable(L,1,0);
  lua_pushliteral(L,"ethereal_wild_onion_4.png");
  lua_rawseti(L,-2,1);
  lua_pushliteral(L,"tiles");
  lua_insert(L,-2);
  lua_settable(L,(2 + lc_nextra));
  ...
  lua_pushliteral(L,"items");
  lua_createtable(L,1,0);
  lua_pushliteral(L,"ethereal:wild_onion_plant 2");
  lua_rawseti(L,-2,1);
  lua_rawset(L,-3);
  lua_pushliteral(L,"rarity");
  lua_pushnumber(L,3);
  ...
  lua_createtable(L,1,0);
  lua_pushliteral(L,"ethereal_wild_onion_5.png");
  lua_rawseti(L,-2,1);
  lua_pushliteral(L,"tiles");
  lua_insert(L,-2);
  lua_settable(L,(2 + lc_nextra));
  ...
  lua_pushliteral(L,"items");
  lua_createtable(L,1,0);
  lua_pushliteral(L,"ethereal:wild_onion_plant 3");
  lua_rawseti(L,-2,1);
  lua_rawset(L,-3);
  lua_pushliteral(L,"rarity");
  lua_pushnumber(L,2);
  ...
  if (lc10) {
    ...
    lua_pushliteral(L,"Ethereal grow onion");
    lua_rawset(L,-3);
