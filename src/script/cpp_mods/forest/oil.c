...
static int lcf1 (lua_State * L) {
  ...
  lua_gettable(L,-2);
  lua_remove(L,-2);
  lua_pushliteral(L,"default_cool_lava");
...
static int lcf_main (lua_State * L) {
  ...
  lua_gettable(L,-2);
  lua_remove(L,-2);
  lua_pushliteral(L,"forest:oil_flowing");
  lua_createtable(L,0,20);
  lua_pushliteral(L,"description");
  lua_pushliteral(L,"Oil flowing");
  lua_rawset(L,-3);
  ...
  lua_pushliteral(L,"oil_flowing_animated.png");
  lua_rawset(L,-3);
  ...
  lua_createtable(L,0,2);
  lua_pushliteral(L,"name");
  lua_pushliteral(L,"oil_source_animated.png");
  lua_rawset(L,-3);
  lua_pushliteral(L,"animation");
  lua_createtable(L,0,4);
  lua_pushliteral(L,"type");
  ...
  lua_createtable(L,1,0);
  lua_pushliteral(L,"group:oil");
  lua_rawseti(L,-2,1);
  lua_rawset(L,-3);
  lua_pushliteral(L,"neighbors");
  lua_createtable(L,1,0);
  lua_pushliteral(L,"group:igniter");
  lua_rawseti(L,-2,1);
  lua_rawset(L,-3);
  ...
  lua_pushliteral(L,"forest:oil_source");
  lua_pushliteral(L,"forest:oil_flowing");
  lua_pushliteral(L,"forest:bucket_oil");
  lua_pushliteral(L,"bucket_oil.png");
  lua_pushliteral(L,"Oil bucket");
  lua_call(L,5,0);
  assert(lua_gettop(L) - lc_nextra == 0);
  return 0;
}
