...
static int lcf1 (lua_State * L) {
  ...
  lua_remove(L,-2);
  lua_pushvalue(L,2);
  lua_pushliteral(L,"nssm:tarantula_propower");
  lua_call(L,2,0);
  assert(lua_gettop(L) == 2);
  return 0;
}
...
static int lcf_main (lua_State * L) {
  ...
  lua_rawset(L,-3);
  lua_pushliteral(L,"mesh");
  lua_pushliteral(L,"tarantula.x");
  lua_rawset(L,-3);
  lua_pushliteral(L,"textures");
  lua_createtable(L,1,0);
  lua_createtable(L,1,0);
  lua_pushliteral(L,"tarantula.png");
  lua_rawseti(L,-2,1);
  lua_rawseti(L,-2,1);
  lua_rawset(L,-3);
  ...
  lua_rawset(L,-3);
  lua_pushliteral(L,"mesh");
  lua_pushliteral(L,"tarantula_propower.x");
  lua_rawset(L,-3);
  lua_pushliteral(L,"textures");
  lua_createtable(L,1,0);
  lua_createtable(L,1,0);
