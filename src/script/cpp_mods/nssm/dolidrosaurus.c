...
static int lcf_main (lua_State * L) {
  ...
  lua_rawset(L,-3);
  lua_pushliteral(L,"mesh");
  lua_pushliteral(L,"dolidrosaurus.x");
  lua_rawset(L,-3);
  lua_pushliteral(L,"textures");
  lua_createtable(L,5,0);
  lua_createtable(L,1,0);
  lua_pushliteral(L,"dolidrosaurus1.png");
  lua_rawseti(L,-2,1);
  lua_rawseti(L,-2,1);
  lua_createtable(L,1,0);
  lua_pushliteral(L,"dolidrosaurus2.png");
  lua_rawseti(L,-2,1);
  lua_rawseti(L,-2,2);
  lua_createtable(L,1,0);
  lua_pushliteral(L,"dolidrosaurus3.png");
  lua_rawseti(L,-2,1);
  lua_rawseti(L,-2,3);
  lua_createtable(L,1,0);
  lua_pushliteral(L,"dolidrosaurus4.png");
  lua_rawseti(L,-2,1);
  lua_rawseti(L,-2,4);
  lua_createtable(L,1,0);
  lua_pushliteral(L,"dolidrosaurus5.png");
  lua_rawseti(L,-2,1);
  lua_rawseti(L,-2,5);
  lua_rawset(L,-3);
