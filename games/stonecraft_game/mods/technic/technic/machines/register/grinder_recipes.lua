...
register_dust(S("Carbon Steel"),    "technic:carbon_steel_ingot")
register_dust(S("Cast Iron"),       "technic:cast_iron_ingot")
register_dust(S("Chromium"),        "technic:chromium_ingot")
register_dust(S("Coal"),            nil)
register_dust(S("Copper"),          "default:copper_ingot")
register_dust(S("Lead"),            "technic:lead_ingot")
...
register_dust(S("Sulfur"),          nil)
register_dust(S("Tin"),             "moreores:tin_ingot")
register_dust(S("Wrought Iron"),    "technic:wrought_iron_ingot")
