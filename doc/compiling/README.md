...
General options and their default values:
    ...
    BUILD_CLIENT=TRUE          - Build Stonecraft client
    BUILD_SERVER=FALSE         - Build Stonecraft server
    ...
    INSTALL_DEVTEST=FALSE      - Whether the Development Test game should be installed alongside Stonecraft
    ...
    VERSION_EXTRA=             - Text to append to version (e.g. VERSION_EXTRA=foobar -> Stonecraft 5.10.0-foobar)
